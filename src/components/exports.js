...
export { default as SafeBuy } from './safeBuy/SafeBuy';
export { default as CardReports } from './cardReports/CardReports';

export { default as ImgDispenderFechado } from '../assets/dispenserFechado.png';
export { default as ImgDispenser } from '../assets/dispenserAberto.png';
export { default as ImgSuporte } from '../assets/Suporte.png';
